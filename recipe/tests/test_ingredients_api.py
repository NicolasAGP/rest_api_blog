...
class PublicIngredientsApiTests(TestCase):
    """ Probar API Ingredientes accesible publiucamente """
...
class PrivateIngredientsApiTest(TestCase):
    """Probar API Ingredients accesible privado"""
    ...
    def test_ingredients_limited_to_user(self):
        """Probar Retornarr ingredientes solamente autenticados por el usuario"""
