...
class PublicUserApiTest(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='tets@gmail.com', password='testpass')
    ...
    def test_create_toke_no_user(self):
        """ Prueba de que eltoken no se cree si no existe un usuario """
    ...
    def test_create_token_missing_field(self):
        """ Progar qyue email y contraseña sean requeridas """
...
class PrivateUserApiTest(TestCase):
    ...
    def tets_retrive_profile_success(self):
